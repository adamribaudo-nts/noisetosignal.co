...
<section class="relative px-8 py-16" style="background-image: url('/img/nasa-dishes-2048.jpg'); background-size: cover; background-position: center top; background-repeat: no-repeat;">
  ...
  <div class="relative z-10 max-w-4xl mx-auto text-center">
    <h2 class="text-3xl font-bold text-white mb-8">Let's Talk</h2>
    <p class="text-lg text-white leading-relaxed mb-8">Ready to bring clarity to your marketing technology? Book a meeting and let's get started.</p>
    <a href="https://calendar.app.google/R1dLgiQqYbFmBvC5A" target="_blank" class="inline-block bg-gray-800 text-white px-8 py-3 hover:bg-opacity-90 transition-colors">
      Book a Meeting
    </a>
  </div>
